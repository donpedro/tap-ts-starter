 ...
 *    an appropriate test file can probably be located under "./testdata")
...
if (fileToParse.endsWith('.ts') || fileToParse.endsWith('.js')) {
  ...
  console.error(
    'Try opening a parsable test file (maybe something from "./testdata"?) in the active tab and then debug again.'
  )
